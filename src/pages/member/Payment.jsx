...
.content3-2 > div:not(.title) {
  width: 80px; 
  padding:10px;  border-left: 2px solid #7e7e7e;
}
}
.content4{
  width: 500px;
  ...
  return (
    <PaymentCss>
      ...
      <div className="content2">
        <div className="content2-1"><h3>구매자</h3></div>
        <div className="content2-2">
          <ul>
            <li><div className="title">이름</div><div className="content">{list && list.buyer.name}</div></li>
            <li><div className="title">이메일</div><div className="content">{list && list.buyer.email}</div></li>
            <li><div className="title">전화 번호</div><div className="content">{list && list.buyer.phoneNum}</div></li>
          </ul>
        </div>
        <div className="content2-1"><h3>받는사람</h3></div>
        <div className="content2-2">
          <ul>
            <li><div className="title">이름</div><div className="content">{name}
              {onName && <input type="text" onChange={chageName} value={newName}></input>}
              <AnotherButton width={"70px"} height={"20px"} value={"변경"} onClick={nemeInput}></AnotherButton>
            ...
            <li className="z2"><div className="title">연락처</div><div className="content">{phone}
              {onPhone && <input type="text" onChange={chagePhone} value={newPhone}></input>}
              <AnotherButton width={"70px"} height={"20px"} value={"변경"} onClick={phoneInput}></AnotherButton></div>
            </li>
            <li><div className="title">배송 요청사항</div><div className="content">{require}
              {onRepuie && <input type="text" onChange={chageRequire} value={newRepuie}></input>}
              <AnotherButton width={"70px"} height={"20px"} value={"추가"} onClick={requireInput}></AnotherButton></div>
